        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80 }}>
          ...
          <FadeIn delay={0.15}>
            <div style={{
              ...
              <div style={{ fontSize: 11, letterSpacing: "0.15em", color: C.gray500, marginBottom: 24, textTransform: "uppercase" }}>Team</div>
              <img
                src="/connor-king.jpg"
                alt="Connor King"
                style={{
                  width: "100%", height: 280, borderRadius: 4, marginBottom: 24,
              ...
              <p style={{ fontSize: 14, lineHeight: 1.7, color: C.gray300, fontWeight: 300, margin: 0 }}>
      ...
      <section style={{
        ...
        <FadeIn>
          <div style={{ maxWidth: 700 }}>
            ...
            <p style={{
              fontFamily: F.h, fontSize: 15, lineHeight: 1.75, color: C.gray300, fontWeight: 300,
            }}>
